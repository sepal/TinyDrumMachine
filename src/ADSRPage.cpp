...
ADSRPage::ADSRPage(LCD_TYPE* display, EncoderInput* encoder, FiveWaySwitch* fiveWaySwitch, ADSRCapable *adsrEngine)
...
ADSRPage::ADSRPage(LCD_TYPE *display, EncoderInput *encoder, FiveWaySwitch *fiveWaySwitch, ADSRCapable *adsrEngine, Page *pageLeft)
