...
ADSRController::ADSRController(int xPos, int yPos, LCD_TYPE *display)
...
AttackController::AttackController(int xPos, int yPos, LCD_TYPE *display)
...
DecayController::DecayController(int xPos, int yPos, LCD_TYPE *display)
    : ADSRController(xPos, yPos, display)
{
}
...
SustainController::SustainController(int xPos, int yPos, LCD_TYPE *display)
    : ADSRController(xPos, yPos, display)
{
}
...
ReleaseController::ReleaseController(int xPos, int yPos, LCD_TYPE *display)
    : ADSRController(xPos, yPos, display)
{
}
...
ADSRControlSelector::ADSRControlSelector(int xPos, int yPos, LCD_TYPE *display,
